...
//import static com.example.sounddstest.Activitys.MainActivity.PlayRelativee;
//import static com.example.sounddstest.Activitys.MainActivity.PuaseRelativee;
...
public class CityRecyclerViewAdapter extends RecyclerView.Adapter<CityRecyclerViewAdapter.MyViewHolder> {
   ...
   // MyViewHolder viewHolder;
    ...
    public CityRecyclerViewAdapter(Context mcontext,List<JSONStringFileAudiomix>formList){
        this.context=mcontext;
        this.formList=formList;
        Log.d("okkokok",""+formList);
    }
   /* public CityRecyclerViewAdapter(Context context){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
       ...
       // holder.withtextView.setText(chipNames1.get(position));
        ...
        Set<String> set = shared.getStringSet("CITY_SOUNDS", null);
        if (set != null) {
            seekbarlist.clear();
        ...
        for (int j = 0; j < seekbarlist.size(); j++) {
            ...
            if (seekbarlist.get(j).equals(chipNames1.get(position))) {
               ...
               // holder.withseekBar.setProgress(MainActivity.volumeSeekbar.get(j));
                Log.d("hjgkbb", "" + MainActivity.VolumeHashMap.get(chipNames1.get(position)));
                holder.withseekBar.setProgress(MainActivity.VolumeHashMap.get(chipNames1.get(position)));
        ...
        holder. RL_withSeekbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              /*  boolean seekShow = false;
                ...
                Set<String> set3 = new HashSet<String>();
                set3.addAll(seekbarlist);
                editor.putStringSet("CITY_SOUNDS", set3);
                editor.apply();
