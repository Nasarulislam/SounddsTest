...
import relaxing.sounds.sleeping.Adapters.customListviewAdapter;
...
public class PlayListDialog extends Dialog {
    ...
    Context context;
    List<sleepJSONFile> formList1;
   relaxing.sounds.sleeping.Adapters.customListviewAdapter customListviewAdapter;
    ...
    public PlayListDialog(@NonNull Context context, MainActivity activity, List<sleepJSONFile> formList1) {
        super(context);
