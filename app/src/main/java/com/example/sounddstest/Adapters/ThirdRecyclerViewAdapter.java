...
public class ThirdRecyclerViewAdapter extends RecyclerView.Adapter<ThirdRecyclerViewAdapter.MyViewHolder> {
    ...
    public ThirdRecyclerViewAdapter(Context mcontext, List<JSONStringFileAudiomix> formList) {
        this.context = mcontext;
        this.formList = formList;
        Log.d("ikolklk","ok"+formList.size());
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        Log.d("ikolklk","ko"+chipNames1.get(position));
       // holder.withtextView.setText(chipNames1.get(position));
        ...
        Log.d("thirdqwertyu", "seekbarlist" + seekbarlist+"qwer"+chipNames1.size());
        ...
        Log.d("thirdqwertyuiop",""+noofChips);
        int i;
        ...
        holder.RL_withSeekbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putStringSet("THIRD_SOUNDS", set3);
                editor.apply();
        ...
        holder.RL_withoutSeekbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                seekbarlistsub.add(fin);
                set3.addAll(seekbarlistsub);
                editor4.putStringSet("LIST_SOUNDS", set3);
                editor4.apply();
                // notifyDataSetChanged();
               holder.RL_withoutSeekbar.setVisibility(View.GONE);
                holder.RL_withSeekbar.setVisibility(View.VISIBLE);
