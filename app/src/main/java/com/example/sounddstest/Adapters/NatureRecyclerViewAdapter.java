...
public class NatureRecyclerViewAdapter extends RecyclerView.Adapter<NatureRecyclerViewAdapter.MyViewHolder> implements customListviewAdapter.AdapterCallback {
    ...
    public NatureRecyclerViewAdapter(Context mcontext, List<JSONStringFileAudiomix> formList, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
     ...
     //   holder.withseekBar.setBackgroundColor(context.getResources().getColor(R.color.CityFragmentColor));
        holder.withseekBar.setProgressTintList(ColorStateList.valueOf(Color.parseColor("#E854F8")));
        holder.withseekBar.setThumbTintList(ColorStateList.valueOf(Color.parseColor("#E854F8")));
